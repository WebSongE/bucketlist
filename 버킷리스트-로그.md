...
# 2022-01-10
##firebase 계정 생성시 index-839de510.js:1188 POST https://identitytoolkit.googleapis.com/v1/accounts:signUp?key=AIzaSyC4LoKyuGSomTvuRA7uT5aXOrh4WQbic2w 400 에러
*1. 이메일이 이미 있는 경우
*2. TOO_MANY_ATTEMPTS_TRY_LATER
*3. 비밀번호는 6자 이상으로 설정하여야함 
*(참고)https://stackoverflow.com/questions/69654703/getting-400-response-from-firebase-auth-rest-api
